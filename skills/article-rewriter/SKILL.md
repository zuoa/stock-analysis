...
- `publish`：分析、核验、重组、批评、修订、抛光、质检，产出可直接发布版本
...
| Standard | 默认 | 分析 → 选择性调研 → Prompt 快照 → 草稿 → 批评 → 修订 → 成稿 | 大多数文章改写需求，尤其是“翻译并改写” |
| Publish | “深度改写”“公众号成稿”“适合发布”“补充资料并重写” | 分析 → 核验 → 重组 → Prompt 快照 → 草稿 → 批评 → 修订 → 抛光 → 质检 → 成稿 | 要发布、事实敏感、风格要求高或长文任务 |
